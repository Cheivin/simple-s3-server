...
// ref: https://github.com/minio/minio/blob/master/cmd/auth-handler.go
...
func V4SignVerify(r *http.Request, credentials CredentialStore) ErrorCode {
	// Copy request.
	req := *r
	...
	cred, ok := credentials.Get(signV4Values.Credential.accessKey)
	if !ok {
